...
License: LGPL v2.1
    ...
    MINOR = "LibSharedMedia-3.0", 8020002 -- 8.2.0 v2 / increase manually on changes
...
function lib:Register(mediatype, key, data, langmask)
    ...
    if
        mediatype == lib.MediaType.FONT and
            ((langmask and band(langmask, LOCALE_MASK) == 0) or not (langmask or locale_is_western))
     then
    ...
    if
        type(data) == "string" and
            (mediatype == lib.MediaType.BACKGROUND or mediatype == lib.MediaType.BORDER or
                mediatype == lib.MediaType.STATUSBAR or
                mediatype == lib.MediaType.SOUND)
     then
...
function lib:Fetch(mediatype, key, noDefault)
    ...
    local result =
        ...
        ((overridekey and mtt[overridekey] or mtt[key]) or
            (not noDefault and defaultMedia[mediatype] and mtt[defaultMedia[mediatype]])) or
        nil
