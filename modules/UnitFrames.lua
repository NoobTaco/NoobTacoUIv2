...
function NoobTacoUIv2:SetupLayout()
    ...
    E.db["unitframe"]["units"]["player"]["RestIcon"]["xOffset"] = -50
    ...
    E.db["unitframe"]["units"]["player"]["pvpIcon"]["xOffset"] = -100
    E.db["unitframe"]["units"]["player"]["pvpIcon"]["yOffset"] = -10
    E.db["unitframe"]["units"]["player"]["width"] = 150
    ...
    E.db["unitframe"]["units"]["target"]["pvpIcon"]["xOffset"] = 100
    E.db["unitframe"]["units"]["target"]["pvpIcon"]["yOffset"] = -10
